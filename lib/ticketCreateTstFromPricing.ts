...
function ticketCreateTstFromPricing({
	sessionId,
	sequenceNumber,
	securityToken,
	tstRef,
	...
	tstRef.forEach((ref) => {
		tstXml += `<psaList>
              <itemReference>
                ...
                <uniqueReference>${ref}</uniqueReference>
              </itemReference>
            </psaList>`;
	});
	const xml = `<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:sec="http://xml.amadeus.com/2010/06/Security_v1" xmlns:link="http://wsdl.amadeus.com/2010/06/ws/Link_v1" xmlns:ses="http://xml.amadeus.com/2010/06/Session_v3">
                  <soap:Header xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
                      ...
                      <add:Action xmlns:add="http://www.w3.org/2005/08/addressing">http://webservices.amadeus.com/TAUTCQ_04_1_1A</add:Action>
	...
	const soapAction = 'http://webservices.amadeus.com/TAUTCQ_04_1_1A';

	return makeRequest(soapAction, xml);
}

export default ticketCreateTstFromPricing;
