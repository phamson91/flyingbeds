...
function pnrRetrieveByRloc(rloc: string) {
  ...
  const xml = `<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:sec="http://xml.amadeus.com/2010/06/Security_v1" xmlns:link="http://wsdl.amadeus.com/2010/06/ws/Link_v1" xmlns:ses="http://xml.amadeus.com/2010/06/Session_v3">
        <soapenv:Header xmlns:wsa="http://www.w3.org/2005/08/addressing" xmlns:typ="http://xml.amadeus.com/2010/06/Types_v1" xmlns:iat="http://www.iata.org/IATA/2007/00/IATA2010.1">
            <sec:AMA_SecurityHostedUser>
                <sec:UserID POS_Type="1" RequestorType="U" PseudoCityCode="${process.env.LSSOfficeId}" AgentDutyCode="SU">
                    <typ:RequestorID>
  ...
  const soapAction = 'http://webservices.amadeus.com/PNRRET_21_1_1A';

  return makeRequest(soapAction, xml);
}

export default pnrRetrieveByRloc;
