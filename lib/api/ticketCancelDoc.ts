...
function ticketCancelDoc({
    ...
    <soap:Header xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
        ...
        <add:Action xmlns:add="http://www.w3.org/2005/08/addressing">http://webservices.amadeus.com/TRCANQ_11_1_1A</add:Action>
        ...
        ${ticketsNumber
            ...
            <stockProviderDetails>
                <officeSettingsDetails>
                    <stockProviderCode>${airlineCompany}</stockProviderCode>
                </officeSettingsDetails>
            </stockProviderDetails>
            <targetOfficeDetails>
                <originatorDetails>
                    <inHouseIdentification2>HANQH28AA</inHouseIdentification2>
                </originatorDetails>
            </targetOfficeDetails>
        </Ticket_CancelDocument>
    </soapenv:Body>
	...
	const soapAction = 'http://webservices.amadeus.com/TRCANQ_11_1_1A';
	return makeRequest(soapAction, xml);
}

export default ticketCancelDoc;
